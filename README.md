...
- bogda Gate 6：**通过**（2026-08-31）。Gate 7：**S1/S2 影子通过**。NOW-06 软件已合。3101 **已在 RK3528**：MagicDNS `http://rk3528.tail6d8b09.ts.net:3101/`（只读首发；裸 IP `:3101` 404）。接 runner 见握手说明。**不要**切 3100、**不要**研究进 `pi-service`
