...
export function standardRoutes(): Record<string, RouteHandler> {
  return {
    "/api/v1/capabilities": envelope({ profile: "mock-all", projectId: "bogda-main", effectiveAutonomyMode: "supervised", canSubmitRegisteredDeployment: true, canCancelRun: true, canPauseSchedule: true, canPauseWorkQueue: true, canDecideCheckpoint: true, canReviewScientificResult: true, canSetAutonomyMode: false, canResolveModelDecision: true, canSetModelPolicy: false, canPreparePaidRun: false, allowedDeploymentIds: ["deployment-dorm"], allowedScheduleIds: ["schedule-dorm"], allowedQueueIds: ["queue-cpu", "queue-gpu", "queue-service"], allowedWorkPoolNames: ["dorm-x86", "pi-service"] }, {}),
