...
MAGICDNS_HOST="${BOGDA_CONSOLE_MAGICDNS_HOST:-rk3528.tail6d8b09.ts.net}"
PUBLIC_PORT="${BOGDA_CONSOLE_PUBLIC_PORT:-3101}"
...
rm -rf "$STAGE_LOCAL"
echo "deployed. MagicDNS: http://${MAGICDNS_HOST}:${PUBLIC_PORT}/  (loopback on box: http://127.0.0.1:${PUBLIC_PORT}/; tailnet IP :${PUBLIC_PORT} is serve 404)"
