...
> 日期：2026-08-24
>
> 修订：2026-08-28 — 控制面迁到 RK3528；Gate 6 窗 24h。触发式 agent / dsh 能力面 **待定**（§16.1）。2026-08-30：宿舍塔停购，第二台笔记本暂代 `dorm-x86`（未接线）。
>
> 状态：已批准
>
...
当前 i7-11800H、64GB、3060 Laptop 12GB 笔记本继续跟人移动。owner 2026-08-30：拟购宿舍塔因涨价暂停，`dorm-x86` 层暂由**第二台笔记本**顶替。尚未授权 Wake Bridge、新 work pool 或 7×24 worker。协议验证仍可在笔记本上做，不把「第二台在」当成宿舍机已接入。
