...
**Purpose:** Operationalize GRADE and the 7-level Study Design Hierarchy for S2-LR gap analysis.
**Used by:** S2-LR (Systematic Literature Review — gap analysis phase)
**Also used by:** S6 (Section Writing — claim-to-citation alignment), factual_accuracy agent
...
### Gap Analysis Evidence Distribution

In gap analysis, report the aggregate distribution:
...
3. **Support GRADE recommendations** — high-confidence recommendations should trace to HIGH-grade evidence
