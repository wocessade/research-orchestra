...
- if a later section mentions the same figure/table again, link back to the already inserted block instead of duplicating
...
A slightly smaller but correct crop is better than a wider crop that includes unrelated page content.
