...
When the source is a full paper, include all pages or all extractable sections. Do not limit to selected pages or abstract unless the user requests a preview.
...
- If a figure is referenced across multiple sections, anchor it at the first substantive discussion.
