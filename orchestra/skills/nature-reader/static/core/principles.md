...
- extract figures and tables as assets and place them at the first substantive mention
...
This skill is for papers, preprints, and conference proceedings across disciplines, not limited to any journal family.

## Non-negotiable defaults

When the user asks for paper translation, reading, 中英文对照, 原文对照, 全文翻译, or 翻译解读, produce a paragraph-level bilingual reader by default.
